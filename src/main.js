import Vue from 'vue'
import './plugins/cube-ui' // 注册使用cube-ui
...
import { createAPI } from 'cube-ui' // 使用cube-ui提供的createAPI创建UI组件
...
import ToastNew from './components/common/Toast.vue' // 全局创建Toast提示弹窗
...
/*
* 使用：this.$createToastNew()
* */
createAPI(Vue, ToastNew, ['hide'], true)
